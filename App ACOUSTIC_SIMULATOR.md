...
---
 ...
 The `chemical_simulators` module is the physical modeling engine of PlantLeaf, the platform used to monitor plant bioelectrical activity and ultrasonic emissions.
...
```
 ...
 It can therefore be used both by the interactive UI (`MainWindowChemicalSimulator`) and by batch-analysis scripts or notebooks without loading the application's entire graphical stack.
 ...
 **Class:** `MainWindowChemicalSimulator`
